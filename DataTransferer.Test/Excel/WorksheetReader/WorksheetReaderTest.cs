...
namespace DataTransferer.Test
{
    public class WorksheetReaderTest
    {
        ...
        public void CheckNumberOfWorksheets()
        {
            ...
            worksheets.Should().HaveCount(expectedNumberOfWorksheets, $"the file contains {expectedNumberOfWorksheets} worksheets");
        }
        ...
        public void IsCellDateTimeTest(int worksheetIndex, int rowIndex, int columnIndex, bool expectedResult)
        {
            ...
            var result = reader.CellAtCoordinatesContainsDateTime(new ExcelCellCoordinates(worksheetIndex, rowIndex, columnIndex));
